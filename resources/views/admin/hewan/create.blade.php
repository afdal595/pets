        ...
        <div class="card-body">
            <form action="{{ route('admin.hewan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('biografi') is-invalid @enderror" id="biografi" name="biografi" rows="4">{{ old('biografi') }}</textarea>
                    @error('biografi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('umur_min_perawatan') is-invalid @enderror" id="umur_min_perawatan" name="umur_min_perawatan" value="{{ old('umur_min_perawatan') }}" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('umur_max_perawatan') is-invalid @enderror" id="umur_max_perawatan" name="umur_max_perawatan" value="{{ old('umur_max_perawatan') }}" min="0">
